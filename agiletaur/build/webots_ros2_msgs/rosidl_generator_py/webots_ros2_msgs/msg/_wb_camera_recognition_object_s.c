...
bool webots_ros2_msgs__msg__wb_camera_recognition_object__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("webots_ros2_msgs.msg._wb_camera_recognition_object.WbCameraRecognitionObject", full_classname_dest, 76) == 0);
  }
  webots_ros2_msgs__msg__WbCameraRecognitionObject * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of WbCameraRecognitionObject */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("webots_ros2_msgs.msg._wb_camera_recognition_object");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "WbCameraRecognitionObject");
