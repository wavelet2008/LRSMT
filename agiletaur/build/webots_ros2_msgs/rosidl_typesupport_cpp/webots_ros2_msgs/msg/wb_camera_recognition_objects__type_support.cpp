...
static const _WbCameraRecognitionObjects_type_support_symbol_names_t _WbCameraRecognitionObjects_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, webots_ros2_msgs, msg, WbCameraRecognitionObjects)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, webots_ros2_msgs, msg, WbCameraRecognitionObjects)),
  }
};
...
{
  return &::webots_ros2_msgs::msg::rosidl_typesupport_cpp::WbCameraRecognitionObjects_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, webots_ros2_msgs, msg, WbCameraRecognitionObjects)() {
  return get_message_type_support_handle<webots_ros2_msgs::msg::WbCameraRecognitionObjects>();
}
