...
: ${AMENT_CURRENT_PREFIX:="/home/shipengl/LRSMT/agiletaur/src/install/webots_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/webots_description/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/webots_description/environment/path.sh"
